...
class CustomImage extends StatelessWidget {
  CustomImage(this.image, {this.width = 100, this.height = 100, this.bgColor, 
    ...
    this.isNetwork = true, this.radius = 50, this.borderRadius, this.isShadow = true, required Icon Function(dynamic context, dynamic error, dynamic stackTrace) errorBuilder});
  final String image;
  final double width;
  final double height;
